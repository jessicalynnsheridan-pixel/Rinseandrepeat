...
export const WORKSPACE_TEMPLATES: Record<string, WorkspaceField[]> = {
  ...
  s2: [
    ...
    },
    {
      ...
      hint: 'RBC, TD, BMO, Scotiabank, and Relay Canada are popular with Canadian founders',
    },
    {
      id: 'legal_notes',
  ...
  s5: [
    ...
    {
      id: 'brand_colors',
      label: 'Brand Color Hex Codes',
      type: 'brainstorm',
      placeholder: 'Add a hex code (e.g. #C4A264)...',
      hint: 'Pick 2–3 max. Save these in your Canva Brand Kit.',
    },
    {
      id: 'canva_logo_link',
      label: 'Canva Logo Link',
      type: 'text',
      placeholder: 'Paste your Canva design link here once your logo is done...',
      hint: 'Go to Canva.com → search "minimalist logo" templates to start',
    },
    {
      id: 'brand_mission',
      label: 'Brand Mission',
  ...
  d3: [
    ...
    {
      id: 'freebie_idea',
      label: 'Freebie / Lead Magnet Idea',
      type: 'text',
      placeholder: 'e.g. 5-day Instagram growth checklist, Canva template pack, beginner business guide...',
      hint: 'A freebie builds your email list before anyone spends money on you',
    },
    {
      id: 'dm_cta',
      label: 'Instagram DM Call-to-Action',
      type: 'text',
      placeholder: 'e.g. "Comment GUIDE below and I\'ll send it to your DMs"',
      hint: 'Use this in captions and Reels to drive traffic to your freebie automatically',
    },
    {
      id: 'product_description',
      label: 'Paid Product Description Draft',
      type: 'textarea',
    ...
    },
    {
      ...
      label: 'Funnel Plan',
      type: 'textarea',
      placeholder: 'Instagram content → bio link → freebie download → email capture → email sequence → paid offer...',
      hint: 'Write out your full journey from stranger to buyer',
    },
  ],
  dl1: [
    {
  ...
  m1: [
    ...
    },
    {
      ...
      label: 'Business Registration Plan',
      type: 'text',
      placeholder: 'e.g. Incorporating in Ontario through Ownr, or registering as sole prop first...',
    },
    {
